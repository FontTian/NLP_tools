...
# The part of code  may change before you run it

stopwords_path1 = 'stopwords1893.txt'  # 需要添加的停用词词表
stopwords_path2 = 'stopwords1229.txt'  # 需要添加的停用词词表

# set001 = GetSetOfStopWords(stopwords_path1)
# set002 = GetSetOfStopWords(stopwords_path2)
#
...
GetSetOfStopWords(listOfFileName)
